    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event){
        ...
        if(event.getAuthor().isBot())
            ...
            if(args[0].equals(WhiteRanger.prefix + "changelog")){
                ...
                changeLog.setTitle("White Ranger Change Log -- 3/3/19");
                changeLog.addField("Version", WhiteRanger.VERSION, false);
                changeLog.setDescription("- Made adjustments to the \"I'm\" replies." +
                        "\n\n- Created w!ping command. returns the bot's current ping." +
