/**
 * Things to do when a new person enters the server
 * @author Jaeg6
 */
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (args[0].equals(WhiteRanger.prefix + "welcome")) {
            if(args.length < 2){
                ...
                BasicCommands.msg = event.getChannel().getLatestMessageId();
                event.getChannel().deleteMessageById(BasicCommands.msg).queue();
